...
Sometimes you will want to just create a shortcut to a file rather than actually making a copy. Perhaps it is a reference FASTA file that is very big, so making multiple copies of it isn't economical. In the following example, notice how big the `genome.fa` file is:
```{bash}
