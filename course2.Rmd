...
Another common case with rm is when you have a directory and you want to remove it AND everything in it. Remember that complicated file structure we created last time inside `~/sandbox/ourData`? If you wanted to remove `ourData ` and everything in it, you can do it recursively like this:
